...
export function Sidebar({
  ...
  return (
    <>
      ...
      >
        <div className="relative flex items-center justify-center border-b border-navy-800 px-3 py-3">
          <img src="/logo-white.png" alt="Arrow Shot" className="h-[72px] w-auto" />
          <button
