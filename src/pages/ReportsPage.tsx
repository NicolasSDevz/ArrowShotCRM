...
import { Plus, FileDown, Eye, FileBarChart, Search, Trash2, X } from 'lucide-react'
...
export function ReportsPage() {
  ...
  // Só clientes que já têm ao menos um relatório aparecem no filtro — uma
  // lista de todos os clientes da agência aqui ficaria enorme e inútil.
        ...
        <div>
          ...
          <p className="text-[15px] text-[#64748B]">
            {filtered.length === reports.length
              ? `${reports.length} relatório(s) — desempenho mensal e semanal por cliente`
              : `${filtered.length} de ${reports.length} relatório(s)`}
          </p>
        </div>
